...
<nav class="sticky top-0 bg-white shadow-md border-gray-200 dark:bg-gray-900">
    ...
    <div class="flex justify-center items-center sm:gap-6 gap-2.5 shadow md:py-3 py-4 fixed bottom-0 w-full min-w-full bg-white border border-t-2">
        <h3 class="bg-gray-700 text-white px-3 py-1 rounded-lg">Navbar</h3>
        <h3 class="bg-gray-700 text-white px-3 py-1 rounded-lg">Navbar</h3>
        <h3 class="bg-gray-700 text-white px-3 py-1 rounded-lg">Navbar</h3>
        <h3 class="bg-gray-700 text-white px-3 py-1 rounded-lg">Navbar</h3>
    </div>
