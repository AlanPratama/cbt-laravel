      ...
      <section class="section hero" id="home">
        <div class="container">
          ...
          <figure class="hero-banner">
            <img src="https://codewithsadee.github.io/techx/assets/images/hero-banner.png" width="804" height="643" loading="lazy" alt="hero banner"
              class="w-100">
          </figure>
          ...
          <div class="hero-content">
            ...
            <ul class="hero-list">
              ...
              <li class="hero-item">
                <img src="https://codewithsadee.github.io/techx/assets/images/check-circle.svg" width="16" height="16" loading="lazy" alt="Checkmark icon">
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card">
                ...
                <figure class="card-banner">
                  <img src="https://codewithsadee.github.io/techx/assets/images/service-1.gif" width="728" height="344" loading="lazy" alt="support"
                    class="w-100">
                </figure>
            ...
            <li>
              <div class="service-card">
                ...
                <figure class="card-banner">
                  <img src="https://codewithsadee.github.io/techx/assets/images/service-2.gif" width="728" height="344" loading="lazy" alt="Engagement"
                    class="w-100">
                </figure>
            ...
            <li>
              <div class="service-card">
                ...
                <figure class="card-banner">
                  <img src="https://codewithsadee.github.io/techx/assets/images/service-3.gif" width="728" height="344" loading="lazy" alt="Marketing"
                    class="w-100">
                </figure>
        ...
        <div class="container">
          ...
          <div class="features-content">
            ...
            <ul class="features-list">
              ...
              <li class="features-item">
                <img src="https://codewithsadee.github.io/techx/assets/images/features-icon-1.svg" width="26" height="26" loading="lazy" aria-hidden="true"
                  class="item-icon">
              ...
              <li class="features-item">
                <img src="https://codewithsadee.github.io/techx/assets/images/features-icon-2.svg" width="26" height="26" loading="lazy" aria-hidden="true"
                  class="item-icon">
              ...
              <li class="features-item">
                <img src="https://codewithsadee.github.io/techx/assets/images/features-icon-3.svg" width="26" height="26" loading="lazy" aria-hidden="true"
                  class="item-icon">
              ...
              <li class="features-item">
                <img src="https://codewithsadee.github.io/techx/assets/images/features-icon-4.svg" width="26" height="26" loading="lazy" aria-hidden="true"
                  class="item-icon">
          ...
          <div class="banner-wrapper">
            ...
            <figure class="features-banner one">
              <img src="https://codewithsadee.github.io/techx/assets/images/features-banner-1.gif" width="600" height="500" loading="lazy"
                alt="features image" class="w-100">
            </figure>

            <figure class="features-banner two">
              <img src="https://codewithsadee.github.io/techx/assets/images/features-banner-2.png" width="436" height="311" loading="lazy"
                alt="features image" class="w-100">
            </figure>
          ...
          <ul class="about-list">
            ...
            <li>
              <div class="about-card about-card-1">
                ...
                <figure class="card-banner">
                  <img src="https://codewithsadee.github.io/techx/assets/images/about-img-1.svg" width="94" height="94" loading="lazy"
            ...
            <li>
              <div class="about-card about-card-2">
                ...
                <figure class="card-banner">
                  <img src="https://codewithsadee.github.io/techx/assets/images/about-img-2.svg" width="94" height="94" loading="lazy"
            ...
            <li>
              <div class="about-card about-card-3">
                ...
                <figure class="card-banner">
                  <img src="https://codewithsadee.github.io/techx/assets/images/about-img-3.svg" width="94" height="94" loading="lazy"
            ...
            <li>
              <div class="about-card about-card-4">
                ...
                <figure class="card-banner">
                  <img src="https://codewithsadee.github.io/techx/assets/images/about-img-4.svg" width="94" height="94" loading="lazy"
      ...
      <section class="section stats">
        <div class="container">
          ...
          <figure class="stats-banner">
            <img src="https://codewithsadee.github.io/techx/assets/images/stats-banner.png" width="619" height="482" loading="lazy" alt="stats"
              class="w-100">
          </figure>
      ...
      <section class="section app">
        <div class="container">
          ...
          <div class="app-content">
            ...
            <div class="btn-group">
              ...
              <a href="#" class="btn btn-primary">
                <img src="https://codewithsadee.github.io/techx/assets/images/play-store.svg" width="30" height="31" loading="lazy" alt="play store icon">
              ...
              <a href="#" class="btn btn-secondary">
                <img src="https://codewithsadee.github.io/techx/assets/images/play-store.svg" width="30" height="31" loading="lazy" alt="apple store icon">
          ...
          <figure class="app-banner">
            <img src="https://codewithsadee.github.io/techx/assets/images/app-banner.png" width="748" height="536" loading="lazy" alt="app screenshot"
              class="w-100">
          </figure>
  ...
  <footer class="footer">
      ...
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <figure class="footer-img">
            <img src="https://codewithsadee.github.io/techx/assets/images/footer-img.png" width="264" height="226" loading="lazy" aria-hidden="true"
              class="w-100">
          </figure>
        </div>
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            <img src="https://codewithsadee.github.io/techx/assets/images/contact-icon-1.svg" width="16" height="16" loading="lazy" aria-hidden="true">
          ...
          <li class="footer-item">
            <img src="https://codewithsadee.github.io/techx/assets/images/contact-icon-2.svg" width="16" height="16" loading="lazy" aria-hidden="true">
          ...
          <li class="footer-item">
            <img src="https://codewithsadee.github.io/techx/assets/images/contact-icon-3.svg" width="16" height="16" loading="lazy" aria-hidden="true">
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2022 <span class="span">Techx</span>. All rights reserved by <a href="#"
